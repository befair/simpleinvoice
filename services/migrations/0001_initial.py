    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.IntegerField(help_text='indicator of a period by raw units.', null=True, blank=True)),
                ...
                ('period_unit_display', models.CharField(default=b'months', help_text='display measure unit for period', max_length=16, blank=True, choices=[(b'months', 'Months'), (b'hours', 'Hours')])),
                ('period_unit_source', models.CharField(default=b'epoch_now', max_length=32)),
                ('amount', models.DecimalField(max_digits=12, decimal_places=2)),
                ('default_vat_percent', models.DecimalField(default=Decimal('0.21'), max_digits=3, decimal_places=2)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_paid_for', models.IntegerField(help_text='For what has he paid? (incremental value)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_for', models.IntegerField(help_text='For what has he paid? (incremental value)')),
                ('note', models.TextField(blank=True)),
            ],
            options={
