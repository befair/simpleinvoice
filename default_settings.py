...
DATABASE_NAME = os.path.join(BASE_DIR, 'invoice.db')  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'xj=)ikt2m0*d^!61n+hk*)6tc7&3f%2py&u@_jr-d-o$#5-d)8'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'simpleinvoice.context_processor.common_processor',
)
